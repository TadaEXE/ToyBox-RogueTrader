...
public partial class CameraElevationOffsetFeature : FeatureWithPatch
{
    ...
    [HarmonyPatch(typeof(CameraRig), nameof(CameraRig.ScrollTo)), HarmonyPrefix, HarmonyPriority(Priority.HigherThanNormal)]
    private static void CameraRig_ScrollTo_Patch(ref Vector3 position)
    {
        position.y += Settings.CameraElevationOffset;
    }
}
